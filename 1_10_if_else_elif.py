...
передачи “Здоровье”, выведите “Это нормально”. Если Аня спит менее A часов, выведите “Недосып”, если же более B часов, 
то выведите “Пересып”.
...
normalSleep = int(input());
overSleeping = int(input());
annaSleep = int(input());
if annaSleep >= normalSleep and annaSleep <= overSleeping:
    print("Это нормально");
elif annaSleep < normalSleep:
    print("Недосып");
else: 
    print("Пересып");
