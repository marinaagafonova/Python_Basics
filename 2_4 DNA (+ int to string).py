...
s = 'aaaabbсaa' преобразуется в 'a4b2с1a2', то есть группы одинаковых символов исходной строки заменяются на этот символ и количество 
...
if len(DNA) > 0:
    ...
    for i in range(len(DNA)):
        if DNA[i] == char:
            ...
            result += char + str(count); #how to convert int to string in python
            char = DNA[i];
            count = 1;
